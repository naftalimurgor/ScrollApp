...
s.Integrate.onLoad=function(s,m){
    ...
    s.Integrate.Eyeblaster_ACM.aID=69173;
    s.Integrate.Eyeblaster_ACM.cID=199463;
    s.Integrate.Eyeblaster_ACM.adVar="eVar35";
    if (!gsAnalytics.reducedAnalytics) {
        s.Integrate.Eyeblaster_ACM.get("https://bs.serving-sys.com/BurstingPipe/ActivityServer.bs?cn=as&vn=omn&activityID=[cID]&advID=[aID]&var=[VAR]&rnd=[RAND]");
    }
...
//LinkedIn pixel
if (gsAnalytics.siteName == "Goldman Sachs" && !gsAnalytics.reducedAnalytics) {
    window['_bizo_data_partner_id'] = "9333";
    gsAnalytics.loadJS('https://js.bizographics.com/insight.min.js');
}
